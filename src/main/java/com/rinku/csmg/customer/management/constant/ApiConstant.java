...
public abstract class ApiConstant {
  ...
  /**
   * Descripcion de la operacion de swagger.
   */
  public static final String API_OPERATION_EMPLOYEE_SEARCH = "Busca un Empleado por una opción";
  /**
   * Nombre de la operacion de empleados.
   */
  public static final String API_EMPLOYEE_DATA = "employee-data";
  /**
   * Nombre de la operacion de roles.
   */
  public static final String API_ROLES_DATA = "roles";
  /**
   * Etiqueta para consultar los roles de los empleado.
   */
  public static final String API_TAG_ROLES_RETRIEVE = "roles-retrieve";
  /**
   * Operacion para consultar los empleados.
   */
  public static final String API_OPERATION_ROLES_RETRIEVE =
